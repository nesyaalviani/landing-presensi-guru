      ...
      <div v-else class="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6">
        <div class="lg:col-span-1">
          <div class="bg-white rounded-lg border border-gray-200 overflow-hidden">
            <div class="bg-gradient-to-b from-blue-150 via-blue-100 to-white h-24 sm:h-32"></div>
          ...
          <div class="mt-4 space-y-2">
            <button
              @click="openEditModal"
              class="w-full flex items-center justify-center gap-2 px-4 py-2.5 bg-blue-500 text-white rounded-lg hover:bg-blue-600 transition-all shadow-sm hover:shadow-md"
            >
              <Edit class="w-4 h-4" />
      ...
      >
        <div class="relative bg-white rounded-lg shadow-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto" @click.stop>
          ...
          <div class="px-4 sm:px-6 py-4">
            <!-- Error alert -->
            <div v-if="editError" class="mb-4 flex items-center gap-2 bg-red-50 border border-red-200 rounded-lg px-3 py-2.5 text-sm text-red-800">
              <AlertCircle class="w-4 h-4 shrink-0" />
              <span>{{ editError }}</span>
            </div>

            <!-- Success alert -->
            <div v-if="editSuccess" class="mb-4 flex items-center gap-2 bg-green-50 border border-green-200 rounded-lg px-3 py-2.5 text-sm text-green-800">
                  ...
                  <div>
                    ...
                    <div class="relative">
                      <input
                        ...
                        class="w-full px-3 py-2 pr-10 text-sm border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors"
          ...
          <div class="px-4 sm:px-6 py-4 border-t border-gray-200 flex flex-col-reverse sm:flex-row justify-end gap-2 sm:gap-3 sticky bottom-0 bg-white">
            <button
              ...
              class="flex items-center justify-center gap-2 px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 transition disabled:opacity-50"
            >
              <X class="w-4 h-4" />
              Batal
            </button>
            <button
              ...
              class="flex items-center justify-center gap-2 px-4 py-2 text-sm font-medium text-white bg-blue-500 rounded-lg hover:bg-blue-600 transition disabled:opacity-50 disabled:cursor-not-allowed"
            >
