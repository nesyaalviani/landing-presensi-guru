            ...
            <tbody class="bg-white divide-y divide-gray-200">
              ...
              <tr class="hover:bg-gray-50 transition-colors">
                ...
                <td class="whitespace-no-wrap py-4 text-sm font-normal text-gray-500 px-6">
                  <div class="inline-flex items-center rounded-full bg-blue-600 py-2 px-3 text-xs text-white">Disetujui
                  </div>
                </td>
              </tr>
            </tbody>
...
<script setup>
import { CircleUserRound, UserCheck, UserX, ArrowUp, Search, Filter, ChevronLeft, ChevronRight } from 'lucide-vue-next'
</script>