<template>
  <div class="min-h-screen bg-gray-50">
    <div class="max-w-7xl mx-auto px-4 py-8">
        ...
        >
            ...
            <div class="flex items-start justify-between">
              ...
              <div class="flex gap-2">
                ...
                <button
                  ...
                  class="p-2 text-gray-600 hover:bg-gray-100 rounded-md transition"
                  title="Detail"
                >
                  <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div class="bg-gray-50 px-6 py-3 border-t border-gray-200">
            <div class="flex items-center gap-2 text-xs text-gray-500">
              ...
              <span>Diinput pada: {{ history.createdAt }}</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <!-- Empty State -->
      <div v-if="filteredHistory.length === 0" class="bg-white rounded-lg shadow-sm border border-gray-200 p-12 text-center">
        <svg class="w-16 h-16 text-gray-400 mx-auto mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
        </svg>
        <h3 class="text-lg font-medium text-gray-900 mb-2">Tidak Ada Riwayat</h3>
        <p class="text-gray-600">Belum ada riwayat presensi yang sesuai dengan filter yang dipilih.</p>
      </div>

      <!-- Pagination -->
      <div class="bg-white px-4 py-3 border-t border-gray-200 sm:px-6 rounded-lg mt-6">
    ...
    >
      <div class="relative max-w-4xl w-full" @click.stop>
        ...
        <img :src="selectedPhoto" alt="Bukti Foto" class="w-full h-auto rounded-lg" />
      </div>
    </div>
  </div>
</template>
