<template>
  <div class="min-h-screen bg-gray-50">
    <div class="max-w-7xl space-y-2 sm:space-y-3">
      ...
      <!-- Empty State -->
      <div v-if="filteredHistory.length === 0" class="bg-white rounded-lg shadow-sm border border-gray-200 p-8 sm:p-12 text-center">
        ...
        <p class="text-sm sm:text-base text-gray-600">Belum ada riwayat presensi yang sesuai dengan filter yang dipilih.</p>
      </div>

      <!-- Pagination -->
      <div class="bg-white px-3 sm:px-6 py-3 border-t border-gray-200 rounded-lg mt-4 sm:mt-6">
