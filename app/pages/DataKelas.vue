    ...
    <div class="mb-6 flex flex-col sm:flex-row gap-3 items-center justify-between">
      <div class="flex flex-col sm:flex-row gap-3 w-full sm:w-auto">
        ...
        <div class="relative w-full sm:w-44">
          <select class="w-full pl-3 pr-8 py-2 text-sm border border-gray-500 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none appearance-none bg-white text-gray-700">
            <option value="">Semua Jurusan</option>
            <option value="rpl">Rekayasa Perangkat Lunak</option>
            <option value="rpl">Perhotelan</option>
          </select>
          <ChevronDown class="absolute right-2.5 top-1/2 transform -translate-y-1/2 h-4 w-4 text-gray-400 pointer-events-none" />
        </div>
              ...
              <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600">
               ...
               <td class="px-6 py-4 whitespace-nowrap">
                <div class="flex items-center gap-2">
                  <button class="p-1.5 text-blue-600 hover:bg-blue-50 rounded-md transition-colors" title="Edit">
...
<script setup>
import { Search, ChevronRight, ChevronLeft, Plus, Pencil, ToggleLeft, ChevronDown } from 'lucide-vue-next'
</script>