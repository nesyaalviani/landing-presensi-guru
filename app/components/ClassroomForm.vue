<template>
    <section class="px-4 sm:px-6 lg:px-8 py-8 bg-white">
        <form @submit.prevent="handleSubmit" class="space-y-4">
            <!-- Nama Kelas -->
            <div>
                <label for="nama-kelas" class="block text-sm font-medium text-gray-700 mb-2">
                    Nama Kelas <span class="text-red-500">*</span>
                </label>
                <input id="nama-kelas" v-model="formData.namaKelas" type="text" placeholder="Contoh: XII RPL 1" required
            ...
            <div>
                ...
                <div class="relative">
                    <select id="jurusan" v-model="formData.jurusan" required
                        class="w-full pl-3 pr-10 py-2 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none appearance-none bg-white">
            ...
            <div class="flex items-center justify-end gap-3 pt-4">
                ...
                <button type="submit"
                    class="flex items-center gap-2 px-4 py-2 text-sm font-semibold text-white bg-blue-500 rounded-lg hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors">
                    <Plus class="h-4 w-4" />
                    Simpan Kelas
                </button>
            </div>
